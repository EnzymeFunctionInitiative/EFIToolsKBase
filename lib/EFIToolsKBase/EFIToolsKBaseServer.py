...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'EFIToolsKBase'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from EFIToolsKBase.EFIToolsKBaseImpl import EFIToolsKBase  # noqa @IgnorePep8
impl_EFIToolsKBase = EFIToolsKBase(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'EFIToolsKBase'
        ...
        self.rpc_service.add(impl_EFIToolsKBase.run_EFIToolsKBase,
        ...
        self.rpc_service.add(impl_EFIToolsKBase.run_EFI_EST_Families,
        ...
        self.rpc_service.add(impl_EFIToolsKBase.run_EFI_GNT_GNT_Submission,
                             name='EFIToolsKBase.run_EFI_GNT_GNT_Submission',
                             types=[dict])
        self.method_authentication['EFIToolsKBase.run_EFI_GNT_GNT_Submission'] = 'required'  # noqa
